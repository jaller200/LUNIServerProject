Project: Lobby Database implemented with PostgreSQL as the backend

Description: This builds the lobby database implementation to a static library.
...
Related projects: LobbyDB_PostgreSQLTest
