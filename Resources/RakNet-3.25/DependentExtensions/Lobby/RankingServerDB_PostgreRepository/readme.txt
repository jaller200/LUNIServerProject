Project: Ranking Database implemented with PostgreSQL as the backend

Description: This builds the ranking database implementation to a static library.
...
Related projects: RankingServerDBTest
